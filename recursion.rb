...
# BC: use length of word
# RC: strips letters from word
# racecar
# compare first/last
# if == recall with new s
def pal(s)
  if s.length <= 1
    return true
  end
...
pal(racecar): return pal(aceca)
pal(aceca): return pal(cec)
pal(cec): return pal(e)
pal(e): return true



# return string of all binary together
...
# travel(1,2) == "ENN NEN NNE"
# travel(2,2) == "EENN ENEN ENNE NEEN NENE NNEE"
